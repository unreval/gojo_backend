...
COGNITIVE_MAX_QUESTIONS_IN_CONTEXT = _int_env(
    'COGNITIVE_MAX_QUESTIONS_IN_CONTEXT', 20, 1,
)
COGNITIVE_BELIEF_COMMIT_MIN_CONFIDENCE = _float_env(
    'COGNITIVE_BELIEF_COMMIT_MIN_CONFIDENCE', 0.78,
)
COGNITIVE_BELIEF_COMMIT_MIN_INDEPENDENT_EVIDENCE = _int_env(
    'COGNITIVE_BELIEF_COMMIT_MIN_INDEPENDENT_EVIDENCE', 2, 1,
)
COGNITIVE_DIARY_RECALL_LIMIT = min(3, _int_env(
